...
const getRecommendationFromML = async (ingredients) => {
  ...
  try {
    ...
    const error = new Error(err.response?.data?.message || err.message || 'Failed to get recommendation from model');
...
module.exports = { getRecommendationFromML, logRecommendation, getRecommendationLogsWithFoodsByUserId };
